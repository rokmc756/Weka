...
# 6. Add Networking
weka cluster host net add 0 --device=ib0 --ips=10.50.0.1 --netmask=24 --gateway=10.0.50.254
weka cluster host net add 1 --device=ib0 --ips=10.50.0.2 --netmask=24 --gateway=10.0.50.254
weka cluster host net add 2 --device=ib0 --ips=10.50.0.3 --netmask=24 --gateway=10.0.50.254
weka cluster host net add 3 --device=ib0 --ips=10.50.0.4 --netmask=24 --gateway=10.0.50.254
weka cluster host net add 4 --device=ib0 --ips=10.50.0.5 --netmask=24 --gateway=10.0.50.254
weka cluster host net add 5 --device=ib0 --ips=10.50.0.6 --netmask=24 --gateway=10.0.50.254
weka cluster host net add 6 --device=ib0 --ips=10.50.0.7 --netmask=24 --gateway=10.0.50.254
weka cluster host net add 7 --device=ib0 --ips=10.50.0.8 --netmask=24 --gateway=10.0.50.254
