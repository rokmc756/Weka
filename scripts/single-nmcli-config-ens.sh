...
nmcli con add con-name conn2 type ethernet ifname ens224 ipv4.method auto
nmcli con add con-name conn3 type ethernet ifname ens256 ipv4.method auto
...
nmcli con modify conn3 ipv4.method manual ipv4.address 192.168.2.14$ENDIP/24
...
nmcli connection modify conn1 802-3-ethernet.mtu 1500
...
nmcli connection modify conn1 ipv4.routes "192.168.0.0/24 table=103" ipv4.routing-rules "priority 103 from 192.168.0.14$ENDIP table 103"
nmcli connection modify conn2 ipv4.routes "192.168.1.0/24 table=100" ipv4.routing-rules "priority 100 from 192.168.1.14$ENDIP table 100"
nmcli connection modify conn3 ipv4.routes "192.168.2.0/24 table=101" ipv4.routing-rules "priority 101 from 192.168.2.14$ENDIP table 101"
