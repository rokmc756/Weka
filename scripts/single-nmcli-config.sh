...
nmcli connection modify conn1 ipv4.routes "192.168.0.0/24 table=99" ipv4.routing-rules "priority 100 from 192.168.0.14$ENDIP table 99"
...
nmcli connection modify conn5 ipv4.routes "192.168.2.0/24 table=200" ipv4.routing-rules "priority 102 from 192.168.2.14$ENDIP table 200"
