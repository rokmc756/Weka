...
nmcli con modify conn1 ipv4.method manual ipv4.address 192.168.0.180/24
...
nmcli con modify conn3 ipv4.method manual ipv4.address 192.168.2.18$ENDIP/24
...
# nmcli connection modify conn2 ipv4.routes "192.168.1.0/24 table=100" +ipv4.routes "0.0.0.0/0 192.168.1.18$ENDIP table=100" ipv4.routing-rules "priority 101 from 192.168.1.1 table 100"
# nmcli connection modify conn3 ipv4.routes "192.168.2.0/24 table=200" +ipv4.routes "0.0.0.0/0 192.168.2.18$ENDIP table=200" ipv4.routing-rules "priority 102 from 192.168.2.1 table 200"

nmcli connection modify conn2 ipv4.routes "192.168.1.0/24 table=100" ipv4.routing-rules "priority 101 from 192.168.1.18$ENDIP table 100"
nmcli connection modify conn3 ipv4.routes "192.168.2.0/24 table=200" ipv4.routing-rules "priority 102 from 192.168.2.18$ENDIP table 200"
