...
ssh rk8-node01 "/root/tools/install/resources_generator.py -f --path /tmp --net eth1/192.168.1.171/24 eth2/192.168.1.181/24 eth3/192.168.1.191/24  --compute-dedicated-cores 1 --drive-dedicated-cores 2 --frontend-dedicated-cores 1 --protocols-memory 0GiB --drives /dev/sdc /dev/sdd"

echo Running Resources generator on host rk8-node02
ssh rk8-node02 "/root/tools/install/resources_generator.py -f --path /tmp --net eth1/192.168.1.172/24 eth2/192.168.1.182/24 eth3/192.168.1.192/24  --compute-dedicated-cores 1 --drive-dedicated-cores 2 --frontend-dedicated-cores 1 --protocols-memory 0GiB --drives /dev/sdc /dev/sdd"

echo Running Resources generator on host rk8-node03
ssh rk8-node03 "/root/tools/install/resources_generator.py -f --path /tmp --net eth1/192.168.1.173/24 eth2/192.168.1.183/24 eth3/192.168.1.193/24  --compute-dedicated-cores 1 --drive-dedicated-cores 2 --frontend-dedicated-cores 1 --protocols-memory 0GiB --drives /dev/sdc /dev/sdd"

echo Running Resources generator on host rk8-node04
ssh rk8-node04 "/root/tools/install/resources_generator.py -f --path /tmp --net eth1/192.168.1.174/24 eth2/192.168.1.184/24 eth3/192.168.1.194/24  --compute-dedicated-cores 1 --drive-dedicated-cores 2 --frontend-dedicated-cores 1 --protocols-memory 0GiB --drives /dev/sdc /dev/sdd"

echo Running Resources generator on host rk8-node05
ssh rk8-node05 "/root/tools/install/resources_generator.py -f --path /tmp --net eth1/192.168.1.175/24 eth2/192.168.1.185/24 eth3/192.168.1.195/24  --compute-dedicated-cores 1 --drive-dedicated-cores 2 --frontend-dedicated-cores 1 --protocols-memory 0GiB --drives /dev/sdc /dev/sdd"


pdsh -w 192.168.0.17[1-5] "weka local setup container --resources-path /tmp/drives0.json"
...
pdsh -w 192.168.0.17[1-5] "weka local setup host --name compute0 --resources-path /tmp/compute0.json --management-ips=\$(hostname -i)"     # --> It works
...
pdsh -w 192.168.0.17[1-5] "weka local setup host --name frontend0 --resources-path /tmp/frontend0.json --management-ips=\$(hostname -i)"   # --> It works
